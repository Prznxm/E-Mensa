...
require_once($_SERVER['DOCUMENT_ROOT'].'/../models/Gerichte.php');
        ...
        if(isset($_GET['id'])){
            ...
            foreach ($userData as $key => $item) {
                if ($userData[$key]['bildname'] == NULL) {
                    $userData[$key]['bildname'] = "/img/gerichte/00_image_missing.jpg";
                } else {
                    $userData[$key]['bildname'] = "/img/gerichte/" . $item['bildname'];
                }
            }
        }
