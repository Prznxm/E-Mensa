...
@section('header')
    ...
    <script>
        ...
        document.getElementById('logo').addEventListener('click', function() {
            window.location.href = '/public/'; // Hier die URL deiner Hauptseite einfügen
        });
    </script>
@endsection
<hr>
...
@section('main-content')
        ...
        <tr>
            ...
            <td>
                @for($i = $item['sterne']; $i >0; $i--)
                    ...
                    <img src="/../public/img/Star-icon.png" alt="Stern Bild">
    ...
    <script>
        function highlightRating(bewertungID) {
            window.location.href = '/public/bewertungen?glowUP=' + encodeURIComponent(bewertungID);
        }
    </script>
